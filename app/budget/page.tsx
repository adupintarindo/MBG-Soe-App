  ...
  return (
    <div>
      ...
      <PageContainer>
        ...
        <Section icon="🔥" title={t("bud.burnTitle", lang)} hint={t("bud.burnHint", lang)}>
          {burn.length === 0 ? (
        ...
        <Section icon="🍱" title={t("bud.cppTitle", lang)} hint={t("bud.cppHint", lang)}>
          {cpp.length === 0 ? (
            <EmptyState message={t("common.noData", lang)} />
          ) : (
        ...
        <Section icon="💰" title={t("bud.budgetsTitle", lang)} hint={t("bud.budgetsHint", lang)}>
          {budgetRows.length === 0 ? (
            <EmptyState
              icon="💡"
              message={
