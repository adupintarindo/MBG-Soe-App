-- Combined: 0022 + 0023 for one-shot paste to Supabase SQL Editor
-- Builds on migration 0017 (weekly price list tables/RLS) which must already be applied.
begin;

-- >>> 0022_price_list_rpcs.sql ===========================================
-- =============================================================================
-- 0022 · Weekly Price List · RPC helpers (upsert + bulk import)
-- -----------------------------------------------------------------------------
