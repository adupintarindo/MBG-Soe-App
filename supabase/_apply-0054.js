...
// Apply migration 0054 (quotation_seed_from_menu RPC)
const fs = require("fs");
...
function resolveDbUrl() {
  ...
  // Pooler region ap-southeast-1 (Singapore) — konsisten dengan existing scripts
...
async function main() {
  ...
  console.log("▶ Applying 0054_quotation_seed_menu_override.sql");
